...
ENV LIFERAY_DIR=liferay-ce-portal-7.0-ga4
...
RUN cd /tmp && \
	...
	"https://sourceforge.net/projects/lportal/files/Liferay%20Portal/7.0.3%20GA4/liferay-ce-portal-tomcat-7.0-ga4-20170613175008905.zip" && \
